...
STORE_IDENTITY = {
    **QUALIFICATION_IDENTITY,
    "packageName": "1659hashfunction.TwinQuay",
...
def verify_record_inputs(package, record_path, release, artwork, source_commit, inventory, startup, source_root, identity_mode="qualification"):
    identity_for_mode(identity_mode)
...
def build_qualification(
    release, artwork, source_commit, makeappx, sdk_version, output, inventory, startup, source_root, runner=_run, identity_mode="qualification"
):
