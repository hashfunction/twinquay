...
class ResultWindow(QMainWindow):
    ...
    def _setupMenu(self):
        ...
        self.menuActions.addAction(self.app.actionQuarantineReceipts)
        self.menuActions.addAction(self.app.actionImportLegacySettings)
    ...
    def deleteTriggered(self):
        self.app.model.preview_cleanup_plan()
