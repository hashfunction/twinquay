...
class DirectoriesDialog(QMainWindow):
    ...
    def _setupMenu(self):
        ...
        self.menuFile.addAction(self.app.actionQuarantineReceipts)
        self.menuFile.addAction(self.app.actionImportLegacySettings)
    ...
    def _setupUi(self):
        ...
        self.removeFolderButton.setIcon(QIcon(QPixmap(asset_path("minus"))))
        ...
        self.addFolderButton.setIcon(QIcon(QPixmap(asset_path("plus"))))
